...
- [`assets/neon-lab/`](../assets/neon-lab/): 84 SVG được tạo từ script, gồm light/dark, desktop/mobile và bản tĩnh cho các phần có animation.
...
| Bảy bài nghiên cứu và trạng thái | `PAPERS`, `research()` |
| Năm nhóm toolkit | `STACK_GROUPS`, `toolkit()` |
| Email, availability, học vấn | `footer()` |
| Animation | `CSS`, `brain_art()`, `project_defs()`, `profile_defs()` |
